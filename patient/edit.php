...
if(isset($_GET['Registration_Number']))
{
  ...
  $medi = $_POST['emedical_history'];
   $nic=$_POST['epatient_NIC'];
   $abtw=$_POST['eabout_twenty'];
  $gn = $_POST['eguardian_name'];
   $gp = $_POST['eguardian_phonenumber'];
  $ga = $_POST['eguardian_address'];
  $dob = $_POST['eDate_Of_Birth'];
  $gen = $_POST['eGender'];
  $mobi = $_POST['emobile_number'];

  $land=$_POST['eland_number'];
  $add=$_POST['eaddress'];
...
*/
   ...
   $updated =  " UPDATE patient_registration SET
...
<body>
 ...
 <?php
  ...
  {
  $id=$_GET['Registration_Number'];
  $getselect=mysqli_query($connection,"SELECT * FROM patient_registration WHERE Registration_Number='$id'");
...
*/
  ...
  $medi =$profile['medical_history'];
   $nic=$profile['patient_NIC'];
   
  $gn =$profile['guardian_name'];
   $gp = $profile['guardian_phonenumber'];
  $ga = $profile['guardian_address'];
  $dob = $profile['Date_Of_Birth'];
  $gen = $profile['Gender'];
  $mobi = $profile['mobile_number'];

  $land=$profile['land_number'];
  $add=$profile['address'];
        ...
        <ul class="nav navbar-nav" id="mainNav">
         <!-- <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li> -->
          ...
          <!--<li><a href="#dsuf" class="scroll-link">Patient's details edit</a></li>-->
           <li><a href="../reception_nurse/nursehome.php" class="scroll-link">Home</a></li>
...
<div class="container" style="width:60%;margin-top:10px;text-align: left; color:rgba(10,10,10,0.9) ;background-color:rgba(255-255-255);">
  ...
  <form action="" method="post" name="insertform" >
    ...
    <td>  <input type="text" style="text-align:left" name="emedical_history" required placeholder="Medical History"
      value="<?php echo $medi; ?>" id="inputid" /></td>
    <br>
    <br>

      <tr> IC Number : </tr>
    <td><input type="number" style="text-align:left"name="epatient_NIC" required placeholder=" IC Num"
    ...
    <br>
      ...
      <tr>  caretaker 's name : </tr>
    <td>  <input type="text" name="eguardian_name" required placeholder="  caretaker name"
      value="<?php echo  $gn; ?>" id="inputid" /></td>
    <br>
    <br>
    
     <tr> caretaker 's phone number: </tr>
    <td>  <input type="text" name="eguardian_phonenumber" required placeholder="  caretaker phonenumber"
      value="<?php echo  $gp; ?>" id="inputid" /></td>
    <br>
    <br>

     <tr>  caretaker 's address : </tr>
    <td>  <input type="text" name="eguardian_address" required placeholder="  caretaker address"
      value="<?php echo  $ga; ?>" id="inputid" /></td>
    <br>
    <br>
    ...
    <br>
      ...
      <tr> Mobile Number: </tr>
    <td><input type="number" name="emobile_number" required placeholder=" CONTACT Num"
      value="<?php echo $mobi; ?>" id="inputid" /></td>
<br>
<br>

 <tr> Land Line Number : </tr>
    <td><input type="number" name="eland_number" required placeholder=" CONTACT Num"
      value="<?php echo $land; ?>" id="inputid" /></td>
<br>
<br>
     
      <tr> Address : </tr>
    <td>  <input type="text" name="eaddress" required placeholder=" district"
