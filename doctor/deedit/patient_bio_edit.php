      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
         <!-- <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li> -->
          ...
          <li><a href="#dsuf" class="scroll-link">Patient's deatils edit</a></li>
...
<div class="container" style="width:60%;margin-top:10px;text-align: center; color:rgba(10,10,10,0.9) ;background-color:rgba(250,250,250,0.9) ;">
  ...
  <form action="" method="post" name="insertform" >
      ...
      <tr> FIRST NAME : </tr>
      <td><input type="text" name="eFirstName" required placeholder=" First Name"
      value="<?php echo $fname; ?>" id="inputid" /></td>
    <br>
    <br>

      <tr> LAST NAME : </tr>
    <td><input type="text" name="eLastName" required placeholder="Last Name"
    ...
    <br>
      ...
      <tr> IC NUMBER : </tr>
    <td><input type="number" name="epatient_NIC" required placeholder=" IC Num"
      value="<?php echo$nic; ?>" id="inputid" /></td>
    <br>
    <br>

      <tr> eguardian_name : </tr>
    <td>  <input type="text" name="eguardian_name" required placeholder=" guardian_name"
      value="<?php echo  $gn; ?>" id="inputid" /></td>
    <br>
    <br>
    
     <tr> guardian_phonenumber: </tr>
    <td>  <input type="text" name="eguardian_phonenumber" required placeholder=" guardian_phonenumber"
      value="<?php echo  $gp; ?>" id="inputid" /></td>
    <br>
    <br>

     <tr> eguardian_address: </tr>
    <td>  <input type="text" name="eguardian_address" required placeholder=" guardian_address"
