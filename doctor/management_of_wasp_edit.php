...
*/
   ...
   $updated =  " UPDATE management_of_wasp SET
...
<body>
 ...
 <?php
  ...
  {
  $id=$_GET['Patient_Id'];
  $getselect=mysqli_query($connection,"SELECT * FROM management_of_wasp WHERE Patient_Id='$id'");
...
<div class="container" style="width:60%;margin-top:10px;text-align: center; color:rgba(10,10,10,0.9) ;background-color:rgba(250,250,250,0.9) ;">
     <div class="card" >
      ...
      <h2 >management of wasp stings Edit Form </h2>
      <div class="card-body">
         <div class="row"> 
