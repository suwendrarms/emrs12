...
*/
   ...
   $updated =  " UPDATE details_about_bee_stings SET
...
<body>
 ...
 <?php
  ...
  {
  $id=$_GET['Patient_Id'];
  $getselect=mysqli_query($connection,"SELECT * FROM details_about_bee_stings WHERE Patient_Id='$id'");
...
<div class="container" style="width:60%;margin-top:10px;text-align: center; color:rgba(10,10,10,0.9) ;background-color:rgba(250,250,250,0.9) ;">
     <div class="card" >
      ...
      <h2 > Bee stings deatils Edit Form </h2>
      <div class="card-body">
         <div class="row"> 
