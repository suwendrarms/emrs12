...
<!DOCTYPE html>
	...
	<head>
	<meta charset="UTF-8">
	<title>upload and croping your profile image</title>
  ...
  <!--/.container--> 
	...
	<h2>upload and croping your profile image</h2>
			...
			<div class="row">
				...
				<div id="changePic" class="" style="display:none">
					...
					<label>please one click and move the mouse point in to the image then you can crop image</label>
					</form>
