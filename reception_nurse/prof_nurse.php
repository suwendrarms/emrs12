...
*/
   ...
   $updated =  " UPDATE receptionist_registration SET
...
<body>
 ...
 <?php
  ...
  {
  $id=$_GET['username'];
  $getselect=mysqli_query($connection,"SELECT * FROM receptionist_registration WHERE username='$UserName'");
        ...
        <ul class="nav navbar-nav" id="mainNav">
         <!-- <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li> -->
          ...
          <!--<li><a href="#dsuf" class="scroll-link">Patient's details edit</a></li>-->
           <li><a href="nursehome.php" class="scroll-link">Home</a></li>
