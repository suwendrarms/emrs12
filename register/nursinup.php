    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <!--<li><a href="#dsuf" class="scroll-link">Nurse's Sign up form</a></li>
...
<div class="container">
    <div class="heading text-center">   
       <div class="wrapper">
<div class="container" style="width:60%;margin-top:10px;text-align: center; color:rgba(10,10,10,0.9) ;background-color:rgb (255-255-255);">
     <div class="card" >
      <!--<img src="../images/im-7.jpg" class="card-img-top" style="height: 150px ;width: 100%">-->
      <br><br><h2 > Nurse's Registration Form </h2><br>
      <div class="card-body">
         <div class="row"> 
      <form class="form-horizontal" action="Register_nurse.php" method="GET"><p id="head"></p>
                      <!-- Title -->
